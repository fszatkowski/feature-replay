...
def get_eval_plugin(cfg: TDictConfig) -> EvaluationPlugin:
    ...
    wandb_logger = WandBLogger(project_name=cfg.wandb_project, run_name=run_name, config=cfg_dict)
    eval_plugin = EvaluationPlugin(
        ...
        confusion_matrix_metrics(
            stream=True, wandb=True, class_names=[str(i) for i in range(cfg.benchmark.n_classes)]
        ),
